...
<html>
    <head>
        ...
        <title>Adjust Hours | Love Thy Neighbor Community Food Pantry</title>
    </head>
    <body>
        <?php require_once('header.php') ?>
        <h1 style="color: var(--main-color); font-weight: bold;">Adjust <?php echo get_person_by_id($_POST['user_id']); ?></h1>
        <main class="date">
