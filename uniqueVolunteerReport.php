...
<body>
    ...
    <div class="center-header">
        <h1 style="color:black;">Generate Unique Volunteer Report</h1>
    </div>

    <section class="section-box">
        <p style="margin-top: 1rem; text-align:center;">
            Use this tool to generate a PDF report showing volunteers who participated during a selected date range, along with the number of events each volunteer participated in.
        </p>
    </section>

    <main>
        <div class="main-content-box">
            <form method="POST" action="processUniqueVolunteerReport.php">
